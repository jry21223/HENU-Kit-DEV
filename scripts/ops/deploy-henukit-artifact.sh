...
<runtime-dir>/migrations/food, <runtime-dir>/migrations/library and
<runtime-dir>/migrations/portal are applied automatically to their owner
...
# Notice, Food, Library and Portal own their schemas but carry no embedded migration runner,

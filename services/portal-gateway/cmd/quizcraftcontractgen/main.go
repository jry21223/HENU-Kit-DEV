...
func main() {
	...
	getPortalLearningStatePath, getPortalLearningStateMethod, getPortalLearningStateOperation := requireOperation(spec.Paths, "getPortalLearningState")
	...
	validatePortalReadOperation("getPortalLearningState", getPortalLearningStateMethod, getPortalLearningStateOperation, "LearningStateEnvelope", personalStatsSecurityRequirements)
	validatePersonalStatsActorBinding(getPortalLearningStateOperation)
...
func render(catalogPath, statsPath, overallRankingPath, bankRankingPath, createPortalPracticeSessionPath, submitPortalPracticeAnswerPath, createPortalPracticeFeedbackPath, getPortalPracticeFeedbackStatusPath, getPortalFavoritesOverviewPath, listPortalFavoriteQuestionsPath, favoritePortalQuestionPath, unfavoritePortalQuestionPath, createPortalFavoritesSessionPath, getPortalLearningStatePath, digest string) string {

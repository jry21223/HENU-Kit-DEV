...
func TestValidateDataRejectsMissingAndInvalidContractValues(t *testing.T) {
	tests := []struct {
		...
		{name: "summary balance beyond JavaScript-safe range", path: SummaryPath, body: `{"points_balance":9007199254740992,"plan":"free","lifetime":false,"unread_notification_count":0,"open_ticket_count":0}`},
		...
		{name: "points missing entries", path: PointsPath, body: `{"balance":0,"next_cursor":null}`},
		{name: "points missing continuation", path: PointsPath, body: `{"balance":0,"entries":[]}`},
		{name: "points balance beyond JavaScript-safe range", path: PointsPath, body: `{"balance":9007199254740992,"entries":[],"next_cursor":null}`},
		{name: "points positive ledger entry beyond JavaScript-safe range", path: PointsPath, body: `{"balance":0,"entries":[{"id":"11111111-1111-4111-8111-111111111111","amount":9007199254740992,"reason":"adjusted","created_at":"2026-07-28T00:00:00Z"}],"next_cursor":null}`},
		{name: "points negative ledger entry beyond JavaScript-safe range", path: PointsPath, body: `{"balance":0,"entries":[{"id":"11111111-1111-4111-8111-111111111111","amount":-9007199254740992,"reason":"adjusted","created_at":"2026-07-28T00:00:00Z"}],"next_cursor":null}`},
		{name: "points leak audit identity", path: PointsPath, body: `{"balance":0,"entries":[{"id":"11111111-1111-4111-8111-111111111111","amount":1,"reason":"adjusted","created_at":"2026-07-28T00:00:00Z","operator_user_id":"22222222-2222-4222-8222-222222222222"}],"next_cursor":null}`},
		{name: "points blank continuation", path: PointsPath, body: `{"balance":0,"entries":[],"next_cursor":""}`},

-- Seed data for Portal API tables (MySQL)
-- Run after 000001_portal_content.up.sql

INSERT IGNORE INTO portal_food_posts (id, campus, title, excerpt, blocks, author, likes, stars, tags, shop_name, shop_lat, shop_lng, `time`) VALUES
...
('jm-02', 'jinming', '北门胡辣汤：河南人的早八仪式感', '配两块钱的油馍头，满血进教室。',
 ...
 '胡辣汤守卫者', 203, 88, '["早餐","北门","夯"]', '方中山胡辣汤（北门）', 34.8251, 114.3062, '07-17 07:50'),
('lz-01', 'longzihu', '南门灌汤包：先开窗后喝汤', '皮薄汤足，小心烫嘴。',
 '[{"type":"p","text":"南门的灌汤包是开封做法，一笼八只 ¥16。"},{"type":"quote","text":"锐评：刚出笼的能烫掉一层嘴皮，等三分钟。打分：夯。"}]',
 '汤包猎人', 178, 71, '["灌汤包","南门","夯"]', '第一楼灌汤包（南门）', 34.8156, 113.8301, '07-18 11:30'),
('lz-02', 'longzihu', '西区食堂的隐藏窗口：烩面', '本地人认证，汤是羊骨熬的。',
 '[{"type":"p","text":"西区食堂二楼最里面的烩面窗口，¥10 一碗，汤头奶白。"},{"type":"quote","text":"锐评：比校外 ¥18 的强。打分：夯。"}]',
 '你', 145, 60, '["烩面","食堂","夯"]', '龙子湖西区食堂二楼', 34.8180, 113.8275, '07-17 12:20');

INSERT IGNORE INTO portal_food_comments (id, post_id, author, `time`, `text`) VALUES
...
INSERT IGNORE INTO portal_campus_items (id, type, category, title, `desc`, price, seller, credit, deals_done, wants, place, deadline, status, `time`) VALUES
...
INSERT IGNORE INTO portal_campus_messages (id, item_id, author, `time`, `text`) VALUES

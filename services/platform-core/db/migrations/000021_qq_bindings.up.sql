...
CREATE TABLE qq_binding_challenges (
...
CREATE INDEX qq_binding_challenges_expiry ON qq_binding_challenges(expires_at);
CREATE INDEX qq_binding_challenges_user ON qq_binding_challenges(user_id);
CREATE INDEX qq_binding_challenges_session ON qq_binding_challenges(session_id);
CREATE TABLE qq_binding_audit (

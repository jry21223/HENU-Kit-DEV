  ...
  useEffect(() => {
    ...
    mm.add(
      ...
      () => {
         ...
         * （旋转、拉窗口、布局回流）会让每一屏重新长高，而浏览器保持 scrollY 不动，
         * 读者于是落到某个边界上方不足半屏处。这类短落点里，δ 落在 35%~50% 视口高
         * 那一段时探针会少算一屏：读者主要看着下面那一屏，探针却仍把他算在上一屏
         * （δ ≤ 35% 时两者本来一致，δ > 50% 时他确实该算上一屏）。起点少算一屏的下
         * 场：第一处边界上向上滑被判成「已经在第一屏」而空转，整段手势被吃掉；更高
         * 的边界上则从读者看着的那一屏连退两屏。
         */
        const currentIndex = () => {

  ...
  useEffect(() => {
    ...
    mm.add(
      ...
      () => {
         ...
         * scrollY 不动，读者于是落到某个边界上方 35%~50% 视口高处——这时他主要看着
         * 下面那一屏，探针却仍把他算在上一屏（δ ≤ 35% 时两者本来一致，δ > 50% 时他
         * 确实该算上一屏）。起点少算一屏的下场：第一处边界上向上滑被判成「已经在第
         * 一屏」而空转，整段手势被吃掉；更高的边界上则从读者看着的那一屏连退两屏。
         */
        const currentIndex = () => {

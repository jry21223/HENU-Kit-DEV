...
export default function ShelfPage() {
  ...
  return (
    // 与页头同一个内容框，左缘与返回链接对齐；说明仍限在 max-w-2xl。
    <main data-library-shelf-state="unavailable" className="mx-auto max-w-site px-5 py-10 md:px-8">
      <div className="max-w-2xl">
        ...
        <BackLink className="mt-6 border border-ink px-4 py-2 font-mono text-xs text-ink transition-colors hover:bg-ink hover:text-paper" />
      </div>
    </main>
  );
}

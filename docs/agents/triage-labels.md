...
The engineering skills use five canonical triage roles. This file maps them to the GitHub labels used by this repository.
...
| `ready-for-human` | `ready-for-human` | Requires human implementation or authority |

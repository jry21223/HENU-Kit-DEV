...
- Admin material upload and manifest import perform lightweight content checks before files become downloadable assets: PDFs must start with `%PDF`, text/Markdown files cannot contain NUL bytes, and DOCX files must have a ZIP header.

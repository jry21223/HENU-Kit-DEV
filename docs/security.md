...
- Admin course, organization, material, upload, archive, status-change, material-review, blog-review, and AI draft-review operations write server-side operation logs in the same database transaction as the protected mutation.

...
| Stage 10：博客、动态、帖子区 | Blog、Moment、Forum、关系系统 | 部分完成 | Blog/Forum 基础和审核已有；Moment 与关系系统 Go API 基础已补，Web `/moments` 基础动态流已补；用户主页聚合和真实媒体上传仍未完成。 |
| Stage 11：通知、举报、搜索、排行榜 | 通知、举报、搜索、排行榜 | 部分完成 | 通知、举报、Admin 处理已有；基础公开搜索 API 和 Web 搜索页已做；排行榜未做。 |
| Stage 12：Next.js 主站 | 主站完整页面 | 部分完成 | 课程、资料、课程包、Wiki、Blog、Forum、动态、错题、通知等核心页已有；AI/会员/积分/排行榜不足。 |

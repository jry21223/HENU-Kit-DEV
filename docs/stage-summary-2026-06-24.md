...
- Moment 动态与关注 / 互关好友 / 屏蔽的 Go API 基础已补；Web 动态流和用户主页聚合仍未完成。
...
| Stage 10：博客、动态、帖子区 | Blog、Moment、Forum、关系系统 | 部分完成 | Blog/Forum 基础和审核已有；Moment 与关系系统 Go API 基础已补，Web 动态流和用户主页聚合仍未完成。 |

...
完整边界见 [`../../reference/product/PRODUCT_BOUNDARIES.md`](../../reference/product/PRODUCT_BOUNDARIES.md)。
...
1. 安全、隐私和法律要求。
2. ADR 中已批准的架构决策。
3. `docs/reference/product/PRODUCT_BOUNDARIES.md`。
4. `docs/reference/product/DESIGN_SYSTEM.md`。
5. `docs/reference/architecture/MONOREPO_ARCHITECTURE.md`。
6. 本开发规范。
7. 各应用和服务 README。

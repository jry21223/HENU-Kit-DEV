...
| Stage 4：组织架构与课程资料 | 组织/课程 CRUD、资料上传下载、水印、权限 | 部分完成 / 强 MVP | 组织、课程、资料、上传、下载权限、水印、审计、manifest dry-run 预检、manifest 导入、manifest-to-paid-download 测试和目标环境 manual-grant smoke 已实现；真实内测资料导入验收和 OSS/S3 等生产存储仍未完成。 |

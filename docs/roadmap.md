...
- Real WeChat Native API client, official notify signature verification/decryption, appid/mchid validation, and production entitlement issuance after verified payment

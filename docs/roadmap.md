...
- Wiki creator application API, student-facing application/status UI, creator/admin entry submission page, reviewer/admin approval flow, and user role promotion on approval
...
- Wiki "my submissions" workspace, creator workflow refinements, rich text editing, and richer revision diff tooling
